...
//==============================================================================================
    ...
    class Builder(context: Context?, detector: Detector<*>?) {
         ...
         */
        fun setRequestedPreviewSize(
            width: Int,
            height: Int
        ): Builder { // Restrict the requested range to something within the realm of possibility.  The
...
//==============================================================================================
    ...
    fun stop() {
        synchronized(mCameraLock) {
            ...
            if (mCamera != null) {
                ...
                try { // We want to be compatible back to Gingerbread, but SurfaceTexture
     ...
     */
    private inner class PictureStartCallback :
     ...
     */
    private inner class PictureDoneCallback :
...
//==============================================================================================
    ...
    private inner class FrameProcessingRunnable internal constructor(private var mDetector: Detector<*>?) :
        ...
        fun setActive(active: Boolean) {
            synchronized(mLock) {
                mActive = active
                mLock.withLock { condition.signalAll() }
            }
        }
                ...
                synchronized(mLock) {
                    while (mActive && mPendingFrameData == null) {
                        try { // Wait for the next frame to be received from the camera, since we
                            // don't have it yet.
                            mLock.withLock { condition.await() }
                        } catch (e: InterruptedException) {
                            Log.d(
                                TAG,
                    ...
                    if (!mActive) { // Exit the loop once this camera source is stopped or released.  We check
