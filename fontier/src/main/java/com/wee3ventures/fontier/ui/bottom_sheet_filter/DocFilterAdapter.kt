package com.wee3ventures.fontier.ui.bottom_sheet_filter
...
import com.wee3ventures.fontier.DocPicker
    ...
    inner class DocVewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        private fun setDrawableForMime(itemView: View, docType: String) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                ...
                itemView.item_doc_filter_file_ext.backgroundDrawable = mDrawable
            }
        }
    }
